...
class TablesControllerTest < ActionController::TestCase
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post :create, table: { name: @table.name, name_aero: @table.name_aero, name_aptour: @table.name_aptour }
    end
  ...
  test "should update table" do
    patch :update, id: @table, table: { name: @table.name, name_aero: @table.name_aero, name_aptour: @table.name_aptour }
    assert_redirected_to table_path(assigns(:table))
  end
