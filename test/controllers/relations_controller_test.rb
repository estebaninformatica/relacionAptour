...
class RelationsControllerTest < ActionController::TestCase
  ...
  test "should create relation" do
    assert_difference('Relation.count') do
      post :create, relation: { id_aero: @relation.id_aero, id_aptour: @relation.id_aptour, model: @relation.model }
    end
  ...
  test "should update relation" do
    patch :update, id: @relation, relation: { id_aero: @relation.id_aero, id_aptour: @relation.id_aptour, model: @relation.model }
    assert_redirected_to relation_path(assigns(:relation))
  end
